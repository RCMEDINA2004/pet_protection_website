...
const plans = [
  {
    ...
    features: [
      ...
      'Descuento en farmacia (15%)',
      'Telemedicina 24/7',
      'Acceso a red aliada básica',
      'Soporte por WhatsApp',
    ],
    missing: ['Cirugías programadas', 'Exámenes avanzados', 'Plan personalizado'],
  },
  {
    id: 'premium',
    name: 'Premium',
    ...
    features: [
      ...
      'Cirugías programadas incluidas',
      'Exámenes de laboratorio avanzados',
      'Limpieza dental anual',
      'Descuento en farmacia (30%)',
      'Acceso prioritario a red premium',
  ...
  },
  {
    ...
    features: [
      ...
      'Deducibles ajustables',
      'Add-ons de especialidad',
